          ...
          {canEdit && openForm === 'screening' ? (
            ...
            <div className="detail-section__grid">
              {student.data_triagem && (
                <FieldRow label="Data da triagem" value={formatDate(student.data_triagem)} />
              )}
        ...
        <section className="detail-section">
          ...
          {openForm === 'consultation' ? (
            ...
            <div className="consulta-view">
              <div className="detail-section__grid">
                <FieldRow label="Data"   value={formatDate(student.data_consulta) || undefined} />
      ...
      {activeTab === 'delivery' && student.receita_oculos_concluida && (
        <section className="detail-section">
          ...
          {openForm === 'delivery' ? (
            ...
            <div className="detail-section__grid">
              <FieldRow label="Data da entrega" value={formatDate(student.data_entrega_oculos) || undefined} />
