...
export const StudentPrescriptionPDF = ({ student, emittedAt }: Props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={s.page}>
      ...
      <View style={s.body}>
        ...
        <Text style={s.footer}>Receita feita por um profissional da saúde. Data de emissão: {emittedAt}</Text>
      </View>
    </Page>
  </Document>
);
